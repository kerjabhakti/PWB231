    ...
    <table border="1">
        ...
        <tbody>
            ...
            while ($maba = mysqli_fetch_array($query)) {
                ...
                echo "<td>";
                echo "<a href='form-edit.php?id=".$maba['id']."'>Edit</a> | "; // Perbaikan tanda kutip dan tanda kurung
                echo "<a href='hapus.php?id=".$maba['id']."'>Hapus</a>"; // Perbaikan tanda kutip dan penggunaan parameter id
                echo "</td>";
                echo "</tr>";
            }
            ?>
